...
% Additional environments for clarity of conditional/global steps
...
\medskip
\begin{assumption}[Boundary positive-real (P+)]\label{ass:Pplus}
Let \(\mathcal O\) be the outer limit from Theorem~\ref{thm:uniform-eps} and set
...
\]
\end{assumption}
Under Assumption~\ref{ass:Pplus}, the Poisson integral gives that \(2\mathcal J\) is Herglotz on \(\Omega\), and thus
